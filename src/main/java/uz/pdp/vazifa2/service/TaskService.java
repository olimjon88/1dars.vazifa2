...
public class TaskService {
    ...
    public ResponseEntity<Message> add(TaskDto dto) {
        ...
        if (!optionalCategory.isPresent())
            return new ResponseEntity<>(new Message("Category not found",false), HttpStatus.NOT_FOUND);

        Optional<Language> optionalLanguage = languageRepository.findByIdAndStatusTrue(dto.getLanguageId());
        if (!optionalLanguage.isPresent())
            return new ResponseEntity<>(new Message("Language not found",false),HttpStatus.NOT_FOUND);
        ...
        return ResponseEntity.ok(new Message("Task added", true));
    }

    public ResponseEntity<Message> edit(Integer id, TaskDto dto) {
        ...
        return ResponseEntity.ok(new Message("Task edited", true));
    }
    ...
    public ResponseEntity<Message> delete(Integer id) {
        ...
        taskRepository.save(task);
        return ResponseEntity.ok(new Message("Task deleted",true));
    }
